...
static void	another_key(int keycode, t_game *game, double olddir_x, \
double oldplane_x)
{
	double	rotSpeed;
...
static void	left_right(int keycode, t_game *game)
{
	...
	if (game->map.map[(int)(game->player.pos_y + game->player.dir_y \
	* (move_speed * game->player.plane_y))]
	[(int)(game->player.pos_x - game->player.dir_x * \
	(move_speed * game->player.plane_x))] != '1')
	{
